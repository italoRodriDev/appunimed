...
class Step3FormTeleConsultation extends StatelessWidget implements LiquidStep {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                TextAppComponent(
                  value: 'Selecione um consultório para teleconsulta.',
                  fontSize: 16,
                  height: 1.5,
                ),
                SizedBox(height: 20),
                ...
                RadioGroupApp(
                  options: ['Consultório 1', 'Consultório 2'],
                  onChanged: (value) {},
                ),
                SizedBox(height: 100),
              ],
            ...
            children: [
              ...
              Padding(
                ...
                child: TextAppComponent(
                  ...
                  color: AppColor.mediumSecondary,
                  value:
                      'Infelizmente, não encontramos datas livres neste consultório. Você selecionar outro ou tentar novamente em alguns dias.',
                ),
              ),
              SizedBox(height: 8),
            ],
