...
class CardDoctorOffice extends StatefulWidget {
  final CardModel item;
  final Function onPressed;
  const CardDoctorOffice({
    super.key,
    required this.item,
  ...
  @override
  State<CardDoctorOffice> createState() => _CardDoctorOfficeState();
}

class _CardDoctorOfficeState extends State<CardDoctorOffice> {
  @override
