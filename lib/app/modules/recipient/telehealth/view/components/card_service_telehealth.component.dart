...
class CardServiceTelehealthComponent extends StatefulWidget {
  String title;
  String subtitle;
  Function onPressed;
  ...
  @override
  State<CardServiceTelehealthComponent> createState() =>
      _CardServiceTelehealthComponentState();
}

class _CardServiceTelehealthComponentState
    extends State<CardServiceTelehealthComponent> {
  @override
