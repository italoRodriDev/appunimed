...
class CardFoundComponent extends StatefulWidget {
  final FoundModel data;

  const CardFoundComponent({super.key, required this.data});

  @override
  State<CardFoundComponent> createState() => _CardFoundComponentState();
}

class _CardFoundComponentState extends State<CardFoundComponent> {
